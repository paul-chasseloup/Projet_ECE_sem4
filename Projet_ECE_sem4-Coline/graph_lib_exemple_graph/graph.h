...
class Graph
{
    ...
    public:
        ...
        /// methodes liées a la connexité
        void DFS(int i, bool marquage[]);
        Graph Transposee(std::string fichier);
        void remplissage_pile(int i, bool marquage[], std::stack<int> sommets);
        void Kosaraju(std::string nom_du_fichier); /// & ?
};
